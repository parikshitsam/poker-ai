...
def main():
    ...
    class GamePage(Frame):
        def __init__(self, parent, controller):
            ...
            self.prob_frame.place(relx=0, rely=0.1, relwidth=1, relheight=1)

            self.prob = Label(self.prob_frame, bg="forest green")
            self.prob.place(relwidth=1, relheight=1)
            prob_graph = ImageTk.PhotoImage(
                Image.open("cards\\test.png").resize((400, 250), Image.ANTIALIAS))
        ...
        def update(self, game):
            ...
            if self.restart:
                ...
                prob_graph = ImageTk.PhotoImage(Image.open("cards\\test.png").resize((400, 250), Image.ANTIALIAS))
                self.prob.image = prob_graph
                self.prob.configure(image=prob_graph)
                self.restart = False
