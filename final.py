...
import queue
import time
from bar_saver import bar_saver
...
def main():
    ...
    class GamePage(Frame):
        def __init__(self, parent, controller):
            ...
            frame_1 = Frame(canvas, bg='forest green', bd=5)
            ...
            frame_2 = Frame(canvas, bg='forest green', bd=5)
            ...
            frame_3 = Frame(canvas, bg='forest green', bd=5)
            ...
            frame_4 = Frame(canvas, bg='forest green', bd=5)
            ...
            frame_5 = Frame(canvas, bg='forest green', bd=5)
            ...
            frame_anal.place(relx=0, rely=1, relwidth=0.35, relheight=0.35, anchor='sw')

            self.prob_frame = Frame(frame_anal)
            self.prob_frame.place(relx=-0.2, rely=-0.2, relwidth=1.3, relheight=1.3)
        ...
        def update(self, game):
            ...
            if self.restart:
                card_d1 = ImageTk.PhotoImage(Image.open(str("cards\default0.png")).resize((80, 120), Image.ANTIALIAS))
                self.cc_1.image = card_d1
                self.cc_1.configure(image=card_d1)

                card_d2 = ImageTk.PhotoImage(Image.open(str("cards\default0.png")).resize((80, 120), Image.ANTIALIAS))
                self.cc_2.image = card_d2
                self.cc_2.configure(image=card_d2)

                card_d3 = ImageTk.PhotoImage(Image.open(str("cards\default0.png")).resize((80, 120), Image.ANTIALIAS))
                self.cc_3.image = card_d3
                self.cc_3.configure(image=card_d3)

                card_d4 = ImageTk.PhotoImage(Image.open(str("cards\default0.png")).resize((80, 120), Image.ANTIALIAS))
                self.cc_4.image = card_d4
                self.cc_4.configure(image=card_d4)

                card_d5 = ImageTk.PhotoImage(Image.open(str("cards\default0.png")).resize((80, 120), Image.ANTIALIAS))
                self.cc_5.image = card_d5
                self.cc_5.configure(image=card_d5)

                prob_graph = ImageTk.PhotoImage(Image.open("cards\\test.png").resize((350, 220), Image.ANTIALIAS))
                self.prob.image = prob_graph
                self.prob.configure(image=prob_graph)
                self.restart = False
                        ...
                        for player in game.list_of_players_not_out:
                            if player.win:
                                if player.score == max(scores):
                                    ...
                                    card_d1 = ImageTk.PhotoImage(
                                        Image.open("cards\\" + str(game.cards[0]) + ".png").resize((80, 120),
                                                                                                   Image.ANTIALIAS))
                                    self.cc_1.image = card_d1
                                    self.cc_1.configure(image=card_d1)

                                    card_d2 = ImageTk.PhotoImage(
                                        Image.open("cards\\" + str(game.cards[1]) + ".png").resize((80, 120),
                                                                                                   Image.ANTIALIAS))
                                    self.cc_2.image = card_d2
                                    self.cc_2.configure(image=card_d2)

                                    card_d3 = ImageTk.PhotoImage(
                                        Image.open("cards\\" + str(game.cards[2]) + ".png").resize((80, 120),
                                                                                                   Image.ANTIALIAS))
                                    self.cc_3.image = card_d3
                                    self.cc_3.configure(image=card_d3)

                                    card_d4 = ImageTk.PhotoImage(
                                        Image.open("cards\\" + str(game.cards[3]) + ".png").resize((80, 120),
                                                                                                   Image.ANTIALIAS))
                                    self.cc_4.image = card_d4
                                    self.cc_4.configure(image=card_d4)

                                    card_d5 = ImageTk.PhotoImage(
                                        Image.open("cards\\" + str(game.cards[4]) + ".png").resize((80, 120),
                                                                                                   Image.ANTIALIAS))
                                    self.cc_5.image = card_d5
                                    self.cc_5.configure(image=card_d5)
            ...
            try:
                prob = ImageTk.PhotoImage(
                    Image.open("cards\\test.png").resize((300,150),Image.ANTIALIAS))
            ...
            try:
                ...
                card1 = ImageTk.PhotoImage(
                    Image.open("cards\\" + str(game.list_of_players[1].cards[0]) + ".png").resize((80, 125),
                                                                                                  Image.ANTIALIAS))
                self.card1_p1.image = card1
                self.card1_p1.configure(image=card1)

                card1 = ImageTk.PhotoImage(
                    Image.open("cards\\" + str(game.list_of_players[2].cards[0]) + ".png").resize((80, 125),
                                                                                                  Image.ANTIALIAS))
                self.card1_p2.image = card1
                self.card1_p2.configure(image=card1)

                card1 = ImageTk.PhotoImage(
                    Image.open("cards\\" + str(game.list_of_players[3].cards[0]) + ".png").resize((80, 125),
                                                                                                  Image.ANTIALIAS))
                self.card1_p3.image = card1
                self.card1_p3.configure(image=card1)

                card1 = ImageTk.PhotoImage(
                    Image.open("cards\\" + str(game.list_of_players[4].cards[0]) + ".png").resize((80, 125),
                                                                                                  Image.ANTIALIAS))
            ...
            try:
                ...
                card2 = ImageTk.PhotoImage(
                    Image.open("cards\\" + str(game.list_of_players[1].cards[1]) + ".png").resize((80, 125),
                                                                                                  Image.ANTIALIAS))
                self.card2_p1.image = card2
                self.card2_p1.configure(image=card2)

                card2 = ImageTk.PhotoImage(
                    Image.open("cards\\" + str(game.list_of_players[2].cards[1]) + ".png").resize((80, 125),
                                                                                                  Image.ANTIALIAS))
                self.card2_p2.image = card2
                self.card2_p2.configure(image=card2)

                card2 = ImageTk.PhotoImage(
                    Image.open("cards\\" + str(game.list_of_players[3].cards[1]) + ".png").resize((80, 125),
                                                                                                  Image.ANTIALIAS))
                self.card2_p3.image = card2
                self.card2_p3.configure(image=card2)

                card2 = ImageTk.PhotoImage(
                    Image.open("cards\\" + str(game.list_of_players[4].cards[1]) + ".png").resize((80, 125),
                                                                                                  Image.ANTIALIAS))
